...
<body>
  ...
  <body class="text-center">
    <form class="form-signin">
      ...
      <input type="text" name="inputAantal" id="inputAantal" class="form-control" placeholder="Amount IN NGN. Example: NGN5,000" required>
      ...
      <br>
      <button class="btn btn-lg btn-primary btn-block" type="submit" name="report" id="report">Trade DASH</button>
	  <br>
	</form>
	</form>
